...
Zodula supports various field types for different data needs. See the [Field Types](/field-types) documentation for a complete reference of all available field types and their configuration options.
...
- Learn about [Field Types](/field-types) in detail
- Explore [Relationships](/relationships) between DocTypes
- Check out [Permissions](/permissions) for access control
